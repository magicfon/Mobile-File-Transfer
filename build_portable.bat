...
echo echo ⏹️  按 Ctrl+C 可停止伺服器 >> "portable\啟動檔案傳輸.bat"
echo echo. >> "portable\啟動檔案傳輸.bat"
...
echo 1. 雙擊「啟動檔案傳輸.bat」 >> "portable\使用說明.txt"
...
echo - 點擊「下一個IP」按鈕嘗試其他IP >> "portable\使用說明.txt"
echo - 找到可用IP後可點擊「⭐設為預設IP」 >> "portable\使用說明.txt"
echo. >> "portable\使用說明.txt"
echo 📁 上傳的檔案會儲存在「uploads」資料夾 >> "portable\使用說明.txt"
echo. >> "portable\使用說明.txt"
